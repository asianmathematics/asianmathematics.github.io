...
* **Main Mechanics**:  
  ...
  * Retro/terminal look. Ascii art style for now, maybe change to a better art style in the future.
...
* **Banner**: Default banner and monthly banner. Each Banner has two sub-banners:  
  * Field: Features 1★/2★/3★/4★ units. Usually prioritizes Squad Banner compatible units.  
