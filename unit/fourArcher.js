...
export const FourArcher = new Unit("4 (Archer)", [440, 30, 7, 35, 110, 30, 135, 45, 90, 115, "back", 60, 4, 80, 6], ["Light/Illusion", "Harmonic/Change", "Radiance/Purity", "Anomaly/Synthetic"], function() {
    ...
    this.actions.multishot = {
        ...
        cost: { mana: 20 },
        description: "Costs 20 mana\nAttacks up to 3 targets with increased crit chance",
        target: () => {
    ...
    this.actions.luckyAura = {
        ...
        cost: { mana: 40 },
        description: "Costs 40 mana\nIncrease all luck based stats for 2 turns",
        code: () => {
			...
			createMod("Lucky Aura", "Increased luck",
                { caster: self, targets: [self], duration: 3, stats: ["accuracy", "focus", "evasion", "resist", "presence"], values: [0.75, 0.75, 0.25, 0.25, 0.25] },
                (vars) => {
    ...
    this.actions.imposeLuck = {
        ...
        code: (target) => {
            ...
            const self = this;
                ...
                { caster: self, targets: target, duration: 2, stats: ["accuracy", "focus"], values: [0.5, 0.5] },
                (vars) => {
